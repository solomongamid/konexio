     ...
     <nav class="navbar navbar-inverse">
        <div id="scrollTo" class="container-fluid">
          ...
          <ul class="nav navbar-nav links" id="drop-nav">
            ...
            <li><a data-value="About"  href="#">About Konexio</a></li>
            <li><a data-value="team"  href="#" >Team & partners</a></li>
            <li><a data-value="main-act"  href="#">Main Activities</a></li>
            <li><a href="admin/article.php">Articles</a></li>
            <li><a data-value="contact" href="#">Contact</a></li>
            <li><a data-value="testi-m" href="#">Testimonial </a></li>
          </ul>
        </div>
    </nav>
    <!--End list page -->
